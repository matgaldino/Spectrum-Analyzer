...
importsources -name $app_name -path $app_path -linker-script -soft-link
...
lscript generate -app $app_name -path $build_dir/xsct/workspace/$app_name/src -name "lscript"
