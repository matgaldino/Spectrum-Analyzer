...
SYNTH_SRC += ${PROJECT_DIR}/avnet_zedboard/synth/sigma_delta_top.vhd

# top simulation sources
SIM_SRC += ${PROJECT_DIR}/avnet_zedboard/sim/tb_design_1.sv
SIM_SRC += ${PROJECT_DIR}/avnet_zedboard/sim/tb_sigma_delta_top.sv

# testbench modules
SIM_TB += tb_design_1
SIM_TB += tb_sigma_delta_top

# top design
TOP      = sigma_delta_top
SIM_TOP ?= tb_sigma_delta_top
